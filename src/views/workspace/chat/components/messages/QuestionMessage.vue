  ...
  <div class="question-message-wrapper">
    ...
    >
      <template v-if="isTextStyle">
        <div class="collapsed-summary-line question-collapsed-summary-line" @click="toggleCollapse">
...
.question-message.text-style .text-style-body-card {
  background: linear-gradient(135deg, #1E2A1E 0%, #18181B 100%);
  border: 1px solid #10B981;
  border-left: 3px solid #10B981;
  border-radius: 8px;
...
.question-message.text-style.answer-mismatch .text-style-body-card {
  background: linear-gradient(135deg, #2E1E1E 0%, #18181B 100%);
  border-color: #EF4444;
  border-left-color: #EF4444;
}
...
.question-collapsed-summary-line {
  display: flex;
  align-items: center;
  gap: 6px;
  cursor: pointer;
...
.question-message.text-style .question-collapsed-summary-line:hover .header-actions :deep(.copy-btn) {
  opacity: 1;
}

.question-message.text-style .question-content {
  padding: 12px 14px;
}

.question-message.text-style .question-tab-headers {
  padding: 0 14px;
}
