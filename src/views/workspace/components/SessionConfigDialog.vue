...
// 思考设置
const thinkingMode = ref('project')
...
async function loadSessionConfig() {
  ...
  try {
    ...
    if (result && result.config && result.config.settings) {
      ...
      // 思考设置
      const savedThinkingMode = settings.thinkingMode || (settings.thinkingEnabled !== undefined ? 'custom' : 'project')
      ...
      // 项目提示词
      const savedProjectPromptMode = settings.projectPromptMode || 'project'
      projectPromptMode.value = savedProjectPromptMode
      ...
      projectPromptMode.value = 'project'
      projectPromptText.value = ''
        ...
        <template v-else>
          ...
          <div class="config-section">
            ...
            <div class="radio-group">
              ...
              <label class="radio-item">
                <input type="radio" v-model="thinkingMode" value="project" />
                <span>项目</span>
              </label>
              <label class="radio-item">
